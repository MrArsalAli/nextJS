    ...
    <div className="min-h-screen">
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 h-svh mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:h-auto relative h-64 object-cover object-center rounded">
              <Image
                fill={true}
                alt="ecommerce"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:my-24">
              ...
              <div className="my-8">
                ...
                <div className="flex justify-between my-4">
                  ...
                  <p>{doctorInfo.appointmentTime}</p>
                </div>
                <div className="flex justify-between my-4">
                  <div className="flex items-center gap-2">
                    <ClockIcon />
